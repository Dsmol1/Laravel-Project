                ...
                <tbody>
                    ...
                    @foreach($cart->products as $dish)
                        <tr>
                            ...
                            <div class="media">
                                <a class="thumbnail pull-left" href="#"> <img class="media-object mr-5" src="{{ $dish['item']['image'] }}" style="width: 72px; height: 72px;"> </a>
                                <div class="media-body">
                                    <h4 class="media-heading"><a href="#">{{ $dish['item']['title'] }}</a></h4>
                                </div>
                            </div></td>
                            <td class="col-sm-1 col-md-1" style="text-align: center">
                            <input type="email" class="form-control" id="exampleInputEmail1" value="{{ $dish['qty'] }}">
                            </td>
                            <td class="col-sm-1 col-md-1 text-center"><strong>{{ $dish['item']['price'] }} &euro;</strong></td>
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="{{route('checkout')}}" type="button" class="btn btn-success" name="">
